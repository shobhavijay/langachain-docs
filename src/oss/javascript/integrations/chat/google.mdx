...
<Tip>
  ...
  It replaces the older [`@langchain/google-genai`](/oss/integrations/chat/google_generative_ai)
  and [`@langchain/google-vertexai`](/oss/integrations/chat/google_vertex_ai) packages.
  See [legacy packages](/oss/integrations/providers/google#legacy-packages) for migration details.
</Tip>
...
`ChatGoogle` supports standard LangChain [tool calling](/oss/langchain/tools) as
