...
This will help you getting started with the Amazon Kendra [`retriever`](/oss/langchain/retrieval). For detailed documentation of all `AWSKendraRetriever` features and configurations head to the [API reference](https://api.js.langchain.com/classes/langchain_aws.AmazonKendraRetriever.html).
