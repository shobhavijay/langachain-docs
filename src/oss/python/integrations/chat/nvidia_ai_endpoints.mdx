...
For more information on accessing embedding models through this API, refer to the [NVIDIAEmbeddings](/oss/integrations/text_embedding/nvidia_ai_endpoints) documentation.
...
See [How to use chat models to call tools](/oss/langchain/tools) for additional examples.
